...
*๏ sᴀʏᴀ ᴀᴅᴀʟᴀʜ * {} !
➻ ʙᴏᴛ ᴍᴀɴᴀɢᴇ & ᴍᴜsɪᴄ ʏᴀɴɢ ʙɪsᴀ ᴅɪɢᴜɴᴀᴋᴀɴ ᴅɪ ɢʀᴜᴘ ᴀɴᴅᴀ.
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="DanteXSupport"
                        ),
                        InlineKeyboardButton(
...
*ʜᴇʏ,
 ᴛʜɪs ɪs {BOT_NAME},
ᴀɴ ᴏᴩᴇɴ ᴛᴇʟᴇɢʀᴀᴍ ɢʀᴏᴜᴩ ᴍᴀɴᴀɢᴇᴍᴇɴᴛ ʙᴏᴛ.*
